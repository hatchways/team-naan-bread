...
import { Card, CardHeader, CardContent, IconButton, Typography, Link, Box, Grid } from '@material-ui/core';
              ...
              <Grid container>
                ...
                <Grid item xs={4}>
                  <Typography className={classes.cardBookingState}>
                    {booking.accepted ? 'Accepted' : booking.declined ? 'Declined' : 'Pending'}
                  </Typography>
                </Grid>
              </Grid>
            </CardContent>
